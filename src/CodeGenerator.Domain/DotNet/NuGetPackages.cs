...
namespace CodeGenerator.Domain.DotNet
{
    public static class NuGetPackages
    {
        ...
        public static NuGetPackage Syncfusion_Core_WinForms { get; } = new NuGetPackage { PackageId = "Syncfusion.Core.WinForms", Version = "32.1.20" };
        public static NuGetPackage Syncfusion_SfDataGrid_WinForms { get; } = new NuGetPackage { PackageId = "Syncfusion.SfDataGrid.WinForms", Version = "32.1.20" };
        public static NuGetPackage Syncfusion_SfInput_WinForms { get; } = new NuGetPackage { PackageId = "Syncfusion.SfInput.WinForms", Version = "32.1.20" };
        public static NuGetPackage Syncfusion_SfListView_WinForms { get; } = new NuGetPackage { PackageId = "Syncfusion.SfListView.WinForms", Version = "32.1.20" };
        public static NuGetPackage Syncfusion_Shared_Base { get; } = new NuGetPackage { PackageId = "Syncfusion.Shared.Base", Version = "32.1.20" };
        public static NuGetPackage Syncfusion_Tools_Windows { get; } = new NuGetPackage { PackageId = "Syncfusion.Tools.Windows", Version = "32.1.20" };
    }
}
