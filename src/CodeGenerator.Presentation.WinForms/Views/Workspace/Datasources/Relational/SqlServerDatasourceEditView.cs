...
public partial class SqlServerDatasourceEditView : UserControl, IView<SqlServerDatasourceEditViewModel>
{
    ...
    private void ViewModel_PropertyChanged(object? sender, PropertyChangedEventArgs e)
    {
        ...
        if (e.PropertyName == nameof(SqlServerDatasourceEditViewModel.IsConnecting))
        {
            UpdateUI();
        }
        else if (e.PropertyName == nameof(SqlServerDatasourceEditViewModel.ConnectionStatus))
        {
            lblStatus.Text = _viewModel?.ConnectionStatus ?? string.Empty;
        }
        else if (e.PropertyName == nameof(SqlServerDatasourceEditViewModel.ErrorMessage))
        {
            lblError.Text = _viewModel?.ErrorMessage ?? string.Empty;
            lblError.Visible = !string.IsNullOrEmpty(_viewModel?.ErrorMessage);
        }
        else if (e.PropertyName == nameof(SqlServerDatasourceEditViewModel.SelectedObject))
        {
