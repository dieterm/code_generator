...
partial class EventElementEditView
{
    ...
    private void InitializeComponent()
    {
        ...
        chkIsFieldLike = new BooleanField();
        ...
        tableLayoutPanel.Controls.Add(chkIsFieldLike, 0, 2);
        ...
        // chkIsFieldLike
        // 
        chkIsFieldLike.Dock = DockStyle.Top;
        chkIsFieldLike.Label = "Is Field-Like:";
        chkIsFieldLike.Name = "chkIsFieldLike";
        chkIsFieldLike.Size = new Size(374, 30);
        chkIsFieldLike.TabIndex = 2;
        // 
        // EventElementEditView
        // 
        AutoScaleDimensions = new SizeF(7F, 15F);
        AutoScaleMode = AutoScaleMode.Font;
        AutoSize = true;
        Controls.Add(tableLayoutPanel);
        Name = "EventElementEditView";
    ...
    private BooleanField chkIsFieldLike;
}
