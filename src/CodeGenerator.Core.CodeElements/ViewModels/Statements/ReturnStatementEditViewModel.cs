...
public class ReturnStatementEditViewModel : StatementEditViewModelBase<ReturnStatementArtifact, ReturnStatementElement>
{
    public ReturnStatementEditViewModel()
    {
        ExpressionField = new SingleLineTextFieldModel { Label = "Expression", Name = nameof(ReturnStatementArtifact.Expression) };
