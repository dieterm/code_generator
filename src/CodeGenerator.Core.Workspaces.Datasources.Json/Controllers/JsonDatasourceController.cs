...
using PropertyValueChangedEventArgs = CodeGenerator.Core.Workspaces.Datasources.Json.ViewModels.PropertyValueChangedEventArgs;

namespace CodeGenerator.Core.Workspaces.Datasources.Json.Controllers;
        ...
        if (System.IO.File.Exists(artifact.FilePath))
        {
            commands.Add(new ArtifactTreeNodeCommand(ArtifactTreeNodeCommandGroup.COMMAND_GROUP_MANAGE)
            {
                ...
                Execute = async (a) =>
                {
                    ...
                    previewController.ShowExistingFile(artifact.FilePath);
