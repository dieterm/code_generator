...
/// </summary>
public abstract class ArtifactTreeViewController<TTreeViewModel, TArtifactController> : IArtifactTreeViewController 
    where TTreeViewModel : class, IArtifactTreeViewModel
    where TArtifactController : IArtifactController
{
    /// <summary>
    ...
    /// </summary>
    protected virtual IEnumerable<IArtifactController> LoadArtifactControllers()
    {
        var controllers = ServiceProviderHolder.GetServices<TArtifactController>();
        return controllers.Cast<IArtifactController>().ToArray();
    }
