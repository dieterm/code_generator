...
public abstract class ArtifactTreeViewModel<TController> : ViewModelBase, IArtifactTreeViewModel where TController : IArtifactTreeViewController
{
    ...
    public ICommand SelectArtifactCommand => new Shared.RelayCommand((artifact) =>
    {
        SelectedArtifact = artifact as IArtifact;
        ArtifactSelected?.Invoke(this, artifact as IArtifact);
    }, (artifact) => artifact is IArtifact);
