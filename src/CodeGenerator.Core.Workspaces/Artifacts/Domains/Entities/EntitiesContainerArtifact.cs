...
namespace CodeGenerator.Core.Workspaces.Artifacts.Domains.Entities
{
    ...
    /// </summary>
    public class EntitiesContainerArtifact : WorkspaceArtifactBase, IEnumerable<EntityArtifact>
    {
        ...
        public EntitiesContainerArtifact(ArtifactState state, List<string> errors)
            : base(state, errors)
        {
        }
        ...
        protected override WorkspaceArtifactContext? GetOwnContext()
        {
            ...
            {
                Namespace = $"{(Parent as DomainArtifact).Namespace}.Entities"
            };
        }
    }
}
