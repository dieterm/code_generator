...
namespace CodeGenerator.Core.Workspaces.Artifacts.Domains.Entities
{
    ...
    /// </summary>
    public class EntityRelationsContainerArtifact : WorkspaceArtifactBase, IEnumerable<EntityRelationArtifact>
    {
        ...
        public EntityRelationsContainerArtifact(ArtifactState state, List<string> errors)
            : base(state, errors)
        {
        }
