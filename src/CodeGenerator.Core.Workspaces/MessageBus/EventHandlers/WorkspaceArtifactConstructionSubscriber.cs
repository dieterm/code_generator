...
namespace CodeGenerator.Core.Workspaces.Artifacts
{
    public partial class WorkspaceArtifact
    {
        ...
        /// </summary>
        public DatasourcesContainerArtifact Datasources { get { return WorkspaceArtifactConstructionSubscriber.EnsureContainerExists<DatasourcesContainerArtifact>(this); } }
