...
using PropertyValueChangedEventArgs = CodeGenerator.Core.Workspaces.Datasources.PostgreSql.ViewModels.PropertyValueChangedEventArgs;

namespace CodeGenerator.Core.Workspaces.Datasources.PostgreSql.Controllers;
