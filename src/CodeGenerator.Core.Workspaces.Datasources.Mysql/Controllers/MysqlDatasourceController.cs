...
using PropertyValueChangedEventArgs = CodeGenerator.Core.Workspaces.Datasources.Mysql.ViewModels.PropertyValueChangedEventArgs;

namespace CodeGenerator.Core.Workspaces.Datasources.Mysql.Controllers
{
    /// <summary>
