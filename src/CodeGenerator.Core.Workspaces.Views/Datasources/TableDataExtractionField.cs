...
{
    /// <summary>
    /// UserControl for table data extraction: Load Data button + properties panel with Create Entities/ValueTypes.
    /// </summary>
    public partial class TableDataExtractionField : UserControl, IView<TableDataExtractionFieldModel>
    {
        private TableDataExtractionFieldModel? _viewModel;

        public TableDataExtractionField()
        {
            InitializeComponent();
            Disposed += TableDataExtractionField_Disposed;
        }

        private void TableDataExtractionField_Disposed(object? sender, EventArgs e)
        {
            if (_viewModel != null)
            {
                DataBindings.Clear();
        ...
        public void BindViewModel(TableDataExtractionFieldModel viewModel)
        {
            if (_viewModel != null)
            {
                DataBindings.Clear();
        ...
        {
            BindViewModel((TableDataExtractionFieldModel)(object)viewModel);
        }
    }
}
