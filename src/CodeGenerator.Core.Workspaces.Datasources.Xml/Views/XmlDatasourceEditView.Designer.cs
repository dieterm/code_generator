...
{
    partial class XmlDatasourceEditView
    {
        /// <summary> 
        ...
        private void InitializeComponent()
        {
            ...
            grpObjects.Controls.Add(lstProperties);
            grpObjects.Controls.Add(panelFileInfoButtons);
            grpObjects.Controls.Add(lblFileInfo);
            grpObjects.Controls.Add(lblStatus);
            grpObjects.Controls.Add(lblError);
            grpObjects.Location = new Point(10, 150);
            grpObjects.Name = "grpObjects";
            grpObjects.Size = new Size(380, 300);
            grpObjects.TabIndex = 2;
            grpObjects.TabStop = false;
            grpObjects.Text = "File Structure";
            // 
            // lstProperties
            // 
            lstProperties.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
            lstProperties.Columns.AddRange(new ColumnHeader[] { colPropertyName, colDataType, colNullable, colType });
