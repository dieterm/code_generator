...
namespace CodeGenerator.Generators.DotNet.Generators.InfrastructureLayer.SharedScope
{
    ...
    {
        public InfrastructureLayerSharedScopeDotNetProjectGenerator()
            : base(CodeArchitectureLayerArtifact.INFRASTRUCTURE_LAYER, CodeArchitectureLayerArtifact.SHARED_SCOPE)
        {
        }
