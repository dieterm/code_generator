...
namespace CodeGenerator.Generators.DotNet.Generators.InfrastructureLayer.ApplicationScope
{
    ...
    {
        public InfrastructureLayerApplicationScopeDotNetProjectGenerator()
            : base(CodeArchitectureLayerArtifact.INFRASTRUCTURE_LAYER, CodeArchitectureLayerArtifact.APPLICATION_SCOPE)
        {
        }
