...
namespace CodeGenerator.Domain.DesignPatterns.Structural.DependancyInjection
{
    ...
    /// </summary>
    public abstract class DotNetDependancyInjectionFramework : DependancyInjectionFramework
    {
        /// <summary>
        ...
        protected DotNetDependancyInjectionFramework(string id, string name, string description)
