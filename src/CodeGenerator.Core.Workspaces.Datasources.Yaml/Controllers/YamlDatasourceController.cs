...
using PropertyValueChangedEventArgs = CodeGenerator.Core.Workspaces.Datasources.Yaml.ViewModels.PropertyValueChangedEventArgs;

namespace CodeGenerator.Core.Workspaces.Datasources.Yaml.Controllers;
...
public class YamlDatasourceController : WorkspaceArtifactControllerBase<YamlDatasourceArtifact>
{
    ...
    public override bool CanDelete(YamlDatasourceArtifact artifact)
    {
        return artifact.Parent != null;
    }

    public override void Delete(YamlDatasourceArtifact artifact)
    {
