...
/// <summary>
/// Represents a YAML file datasource
/// </summary>
public class YamlDatasourceArtifact : DatasourceArtifact
{
    public const string TYPE_ID = "Yaml";
    public const string YamlTemplateDatasourceProviderDecorator_ID = "YamlTemplateDatasourceProviderDecorator";

    public YamlDatasourceArtifact(string name, string? description = null)
    ...
    {
        return new YamlTableTemplateDatasourceProviderDecorator(YamlTemplateDatasourceProviderDecorator_ID);
    }
    ...
    /// <summary>
    /// Get the table (single table for YAML file)
    /// </summary>
